...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Lapiceros.jpg" alt="..." width="500" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>BOLIGRAFO BIC PUNTO MEDIANO COLORES</strong></font><br><br>
                <li>Precio: Q1.15</li> 
                <li>Color: Azul, Rojo, Negro y Verde</li>
                <li>Marca: BIC</li>
                <li>Material: Plástico</li>
                <li>Tipo de punta: Mediano</li>
                <li>Este bolígrafo es de punto mediano (1.0 mm), tiene un cuerpo hexagonal para evitar que se caiga y una tapa ventilada diseñada para evitar asfixia</li>
            </div>
            </div>
        </div>
    </div>
