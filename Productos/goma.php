...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Goma.jpg" alt="..." width="600" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>GOMA ESCOLAR TUCAN 8 ONZAS</strong></font><br><br>
                <li>Precio: Q7.75</li> 
                <li>Goma escolar blanca en presentación de 8 Onzas</li>
                <li>Ideal para pegar muchas cosas como: Foamy, madera, papel, cartulinas, construcción, cartón y superficies porosas</li>
                <li>NO TÓXICO Y LAVABLE</li>
