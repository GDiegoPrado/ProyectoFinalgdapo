...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Dispensor.jpg" alt="..." width="600" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>DISPENSADOR SCOTCH C 18 MX</strong></font><br><br>
                <li>Precio: Q42.20</li> 
                <li>Permite dispensar con una mano una amplia variedad de cintas gracias a su base antideslizante</li>
                <li>Dispensa cintas estandar en un nucleo de 25,4 mm hasta 19 mm de ancho</li>
                <li>100% reciclado</li>
            </div>
            </div>
        </div>
