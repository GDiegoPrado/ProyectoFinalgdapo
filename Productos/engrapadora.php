...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Engrapadora.jpg" alt="..." width="600" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>ENGRAPADORA ACME MINI SP201 CON GRAPAS</strong></font><br><br>
                <li>Precio: Q12.50</li>
                <li>Engrapadora Mini engrapadora Barrilito Escolar incluye 1000 grapas</li>
            </div>
            </div>
        </div>
    </div>
