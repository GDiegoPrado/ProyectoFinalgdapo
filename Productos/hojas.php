...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Hjs.jpg" alt="..." width="500" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>HOJAS BOND T/OFICIO (CIENTO)</strong></font><br><br>
                <li>Precio: Q10.00</li>
                <li>Material: Papel Bond</li>
                <li>Ciento: 100 hojas tamaño oficio</li>
                <li>Uso recomendado: Impresiones</li>
                <li>Tamaño (Gramaje, Volumen): 80 gr</li> 
            </div>
            </div>
        </div>
    </div>
