...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Cuaderno.jpg" alt="..." width="600" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>CUADERNO CUENCA COSIDO 100 HOJAS</strong></font><br><br>
                <li>Precio: Q23.20</li> 
                <li>Tipo de Pasta: Flexible</li>
                <li>Hojas: 100 Hojas</li>
