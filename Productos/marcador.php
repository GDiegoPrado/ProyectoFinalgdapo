...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Marcador.jpg" alt="..." width="500" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>MARCADOR STAEDTLER ESTUCHE 334 SB 20</strong></font><br><br>
                <li>Precio: Q105.00</li> 
                <li>Marca: STAEDTLER</li>
                <li>Color de tinta: Multicolor</li>
                <li>Número de productos: 20</li>
                <li>Tipo de punta: Fino</li>
                <li>Peso del producto: 0.22 Kilogramos</li>
                <li>Material: Plástico</li>
                <li>Estilo: Estuche con 20 rotuladores</li>
            </div>
            </div>
        </div>
    </div>
