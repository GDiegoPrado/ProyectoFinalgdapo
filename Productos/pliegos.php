...
<head>
    ...
    <title>Papel construccion</title>
</head>
<body>
<div class="navbar">  
  <a href="#">  </a> 
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img src="../img/Papelcons.jpg" alt="..." width="600" height="600">
            </div>
            <div class="col-6">
            <div class="row text-left m-b-20">
            <font face="Arial" size="6"><strong>PLIEGOS DE PAPEL CONSTRUCCION</strong></font><br><br>
                <li>Precio: Q1.60</li> 
                <li>Papel construcción en presentación por pliego</li>
                <li>Contamos con una variedad de 20 colores con los cuales te podrás divertir creando lo que tu imaginación quiera</li>
            </div>
            </div>
        </div>
    </div>
